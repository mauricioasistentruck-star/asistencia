...
echo 3. Iniciando Guardian Anti-Suspension Render (Segundo Plano)...
start "Guardian Anti-Suspension - ASISTENTRUCK" /min cmd /c "cd /d "%~dp0server" && node keepalive.js"
...
echo   Guardian activo: Render no se apagara durante tu jornada.
